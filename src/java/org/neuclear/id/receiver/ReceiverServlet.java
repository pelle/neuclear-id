/*
 * $Id: ReceiverServlet.java,v 1.7 2004/05/25 17:21:55 pelle Exp $
 * $Log: ReceiverServlet.java,v $
 * Revision 1.7  2004/05/25 17:21:55  pelle
 * Put KeyStorePanel into a JScrollPane
 * Fixed some things in the ReceiverServlet
 *
 * Revision 1.6  2004/04/25 07:28:51  pelle
...
//        ctx.log(obj.getEncoded());
        ...
        if (isXML)
            ...
            printHTMLSuccess(writer, receipt, request);
        }
    ...
    protected void printHTMLSuccess(final PrintWriter writer, SignedNamedObject receipt, final HttpServletRequest request) {
